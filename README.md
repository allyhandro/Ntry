...
'https://app-name/ntry/api/collection/query'
for example: Find an Item from an item id
'https://floating-reaches-15168.herokuapp.com/api/items/find_?id="some value that should be escaped or encoded"'
^^^ request to this url results in 
json obj:
[
    id: {this will match ]
    ]
