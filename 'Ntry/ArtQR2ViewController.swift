...
protocol ArtQRV2iewControllerDelegate:class{
    func addItemViewController(controller:ArtQR2ViewController,didFinishEnteringItem item:NSString)
    
}

class ArtQRViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate, ArtQRV2iewControllerDelegate{
