//
//  InOutQRViewController.swift
//  'Ntry
//
//  Created by Caroline Lai on 5/7/17.
...
protocol InOutQRViewControllerDelegate:class{
    func addItemViewController(controller:InOutQRViewController,didFinishEnteringItem item:NSString)
    
}

class InOutQRViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate, LocationQRViewControllerDelegate{
    ...
    @IBAction func selectButton(_ sender: Any) {
        self.performSegue(withIdentifier: "unwindToInOut", sender: self)
    }
